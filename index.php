...
<body>
	...
	<div class="container">
			...
			<div class="col-md-4 review">
				<div class="review-inside">
					<div style="height: 240px">
						...
						<p style="max-height: 96px; overflow-y: auto;">Высокое качество масла от ведущих производителей.
						</p>
					</div>
			...
			<div class="col-md-4 review">
				<div class="review-inside">
					<div style="height: 240px">
						...
						<p style="max-height: 96px; overflow-y: auto;">Капитальный ремонт двигателя в кратчайшие сроки,
			...
			<div class="col-md-4 review">
				<div class="review-inside">
					<div style="height: 240px">
						...
						<p style="max-height: 96px; overflow-y: auto;">Установка новых колёс, замена дисков, заклейка,
		...
		<!--first button-->
		<a class="button row" href="/order/index.php"><span style="text-align: center">Перейти к услугам</span></a>
		...
		<h1 style="text-align: center">Мы на карте</h1>
		...
		<a class="button row" href="order"><span style="text-align: center">Перейти к услугам</span></a>
	</div>
